...
namespace Backbone.Templates.AiCapabilities.Persistence.Repositories.Interfaces;
...
public interface IUserRepository
{
    ...
    /// <param name="cancellationToken">A cancellation token to cancel the operation.</param>
    /// <returns>User if found, otherwise null.</returns>
    ValueTask<User?> GetByEmailAddressAsync(string emailAddress, QueryOptions queryOptions = default, CancellationToken cancellationToken = default);
